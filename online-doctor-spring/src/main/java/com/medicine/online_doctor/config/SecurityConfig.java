...
import com.medicine.online_doctor.filter.JWTFilter;
import com.medicine.online_doctor.service.security.AppUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> request
            .requestMatchers("/register","/login","/hello").permitAll() // Permite acesso ao endpoint /register sem autenticação
